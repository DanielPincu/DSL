...
const missions = [
  ...
  },
  {
    ...
    requiredPhrases: [
      'Jeg skal flytte',
      'Jeg vil gerne ændre min adresse',
  ...
  },
  {
    ...
    requiredPhrases: [
      ...
      'Jeg vil gerne være dansk statsborger',
    ],
  },
];
...
async function seed(): Promise<void> {
  try {
    ...
    for (const mission of missions) {
      console.log(`  ✓ ${mission.title} (${mission.level})`);
    }
